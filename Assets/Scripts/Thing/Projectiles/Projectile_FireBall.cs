...
public class Projectile_FireBall : Thing
{
    ...
    public override void ThingFixedUpdate()
    {
        ...
        this.transform.Translate(Quaternion.Euler(0, 0, 0) * new Vector3(targetDirection.x * speed * Time.deltaTime, 0, targetDirection.y * speed * Time.deltaTime));
